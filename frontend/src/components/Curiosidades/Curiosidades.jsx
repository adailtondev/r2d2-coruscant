...
const Curiosidades = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      description1:
        "Devido à força e intensidade com que Hayden Christensen realizava os movimentos de luta, ele acabou quebrando vários sabres de luz de propósito durante as filmagens. Isso se tornou uma piada nos bastidores, com a equipe de produção brincando que ele tinha 'força demais'.",
      imageUrl:
    ...
    },
    {
      ...
      description1:
        "As filmagens da cena foram realizadas em um set separado e todas as janelas foram cobertas para evitar vazamentos. Além disso, apenas um grupo seleto de membros da equipe de produção e atores, incluindo o próprio Hayden Christensen e o diretor George Lucas, estavam presentes durante as filmagens. Os figurinistas e aderecistas trabalharam em segredo para criar o traje, que foi mantido oculto em um local seguro.",
      imageUrl:
