  ...
  const items = [
    {
      ...
      imageUrl:
        "https://darkside.blog.br/wp-content/uploads/2019/05/02-1296-%C3%97730-CREDITO-HOLLYWOODREPORTER-1024x577.jpg",
    },
    {
      ...
      imageUrl:
        "https://s2.glbimg.com/F9e4hDViZdgFbqlSne8zjDgKZjw=/e.glbimg.com/og/ed/f/original/2018/05/11/8783707784_cd86fb2087_b.jpg",
    },
    {
      ...
      imageUrl:
        "https://mafiadoslivros.com.br/livros/wp-content/uploads/2017/12/George-LucasUma-vida.jpg",
    },
  ];
        ...
        <section className="container flex  gap-10 group text-gray-100 text-justify p-32 rounded-lg bg-gradient-to-tl from-cyan-900 to-black m-12  h-fit w-auto">
          ...
          {selectedItem && (
            <div className="curiosidade-texto gap-8">
              ...
              <img className="w-96 h-60 object-cover" src={selectedItem.imageUrl} alt="" />
            </div>
          )}
        </section>
      </div>
